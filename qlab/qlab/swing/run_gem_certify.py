...
SHARED_LEDGER = str(_REPO_ROOT / DEFAULT_LEDGER_PATH)   # 项目规范共享账本（GEM 已作 gem_firstround 在册）
...
def main(argv=None) -> int:
    ...
    ledger = project_ledger(SHARED_LEDGER)           # GEM 已作 gem_firstround(N=1) 在 canonical 台账，读即可不重登
