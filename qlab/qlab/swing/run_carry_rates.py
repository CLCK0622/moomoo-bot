...
def main(argv=None) -> int:
    ...
    ap.add_argument("--data-dirs", nargs="*",
                    default=["data/rate_carry", "data/daily_full", "data/gem"],
                    help="按序搜 BIL/IEF/TLT parquet（都水已归拢入 data/rate_carry）")
    ap.add_argument("--fred-parquet", default="data/fred_yields.parquet",
